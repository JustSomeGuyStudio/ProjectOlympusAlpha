...
public:	
	...
	UPROPERTY(EditAnywhere,Replicated,BlueprintReadWrite, Category = CoreInput, meta = (DisplayName = "Physanim Handle Holder Reference"))
	...
	*/
	UPROPERTY(EditAnywhere,Replicated, Category = CoreInput, meta = (DisplayName = "Individual Bone Selection"))
...
*/
	...
	/*
	 * If the distance between the current character position and character position in previous frame is beyond this distance, then temporarily teleport and reset the physics state along with the character.
	 */
	UPROPERTY(EditAnywhere, Category = CoreInput, meta = (DisplayName = "Teleport Distance"))
	float Teleport_Distance = 500;

	int teleport_freeze_count = 0;

	FTransform Body_Delta_Transform;
...
public:	
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "z[Server] First Time Initialization"))
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "z[Server] Re-Grab all handles"))
	...
	*/
	...
	UFUNCTION(Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "-z[Server] DragonIK PhysAnims onHitCallback"))
	void Server_OnHitCallback(const FHitResult& Hit,const  FName Optional_Override_Hit_Bone_Name,const FVector& hit_location,const  FVector& hit_impulse_direction,const  FName& hit_bone_name);

	UFUNCTION(NetMulticast,Unreliable,WithValidation)
	void Multicast_OnHitCallback(const FHitResult& Hit,const  FName Optional_Override_Hit_Bone_Name,const  FVector& hit_location,const  FVector& hit_impulse_direction,const  FName& hit_bone_name);



	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "z[Server] SetAllBodiesBelowSimulatePhysics"))
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName =  "z[Server] Cache Simulation State"))
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName =  "z[Server] Release all handles"))
	...
	*/
	UFUNCTION(BlueprintCallable, Category = DragonIK, meta = (DisplayName = "Update Overall Physanim Data"))
	 void UpdatePhysanimData(int LinearStrength, int AngularStrength, int LinearDamp, int AngularDamp);



	UFUNCTION(BlueprintCallable, Category = DragonIK, meta = (DisplayName = "Update Singular Physanim Data"))
	 void UpdateSpecificPhysanimData(FName BoneName,int linear_strength_var, int angular_strength_var, int linear_damp_var, int angular_damp_var);
	

	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "z[Server] Update Physanim Data"))
	void Server_UpdatePhysanimData(int LinearStrength, int AngularStrength, int LinearDamp, int AngularDamp);

	UFUNCTION(NetMulticast,Unreliable,WithValidation)
	void Multicast_UpdatePhysanimData(int LinearStrength, int AngularStrength, int LinearDamp, int AngularDamp);
	

	UFUNCTION(BlueprintCallable, Category = DragonIK, meta = (DisplayName = "Set Interpolation"))
		void SetInterpolation(int inter_value);

	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName =  "z[Server] Set Interpolation"))
	void Server_SetInterpolation(int inter_value);

	UFUNCTION(NetMulticast,Unreliable,WithValidation)
	void Multicast_SetInterpolation(int inter_value);
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "z[Server] Override Bone Handle Transform"))
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName = "z[Server] Modify & Reset Bone Settings"))
	...
	*/
	...
	UFUNCTION(BlueprintCallable,Server,unreliable,WithValidation, Category = DragonIK, meta = (DisplayName =  "z[Server] Perform Active Ragdoll"))
	void Server_PerformActiveRagdoll(float pelvis_mass_override = 1000);

	UFUNCTION(NetMulticast,Unreliable,WithValidation)
	void Multicast_PerformActiveRagdoll(float pelvis_mass_override = 1000);

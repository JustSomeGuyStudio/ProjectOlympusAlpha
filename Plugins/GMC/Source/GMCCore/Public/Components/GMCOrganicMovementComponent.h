...
private:
  ...
  void SaveBaseWorld(bool bSimualted, UGMC_ReplicationCmp* const Outer);
};
...
protected:
  ...
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
  virtual bool MaintainDistanceToFloor(UPARAM(Ref) FGMC_FloorParams& Floor);
...
public:
  ...
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
  EGMC_MovementMode GetMovementMode() const;
...
public:
  ...
  /// @returns      void
  void SetMontageStartDelegate(FGMC_OnMontageStart& InOnMontageStart, const FGMC_MontageTracker& InMontageTracker);
  ...
  /// @param        MontageTracker        The montage tracker associated with the montage.
  /// @returns      void
  void SetMontageBlendInDelegate(FGMC_OnMontageBlendInComplete& InOnMontageBlendIn, const FGMC_MontageTracker& InMontageTracker);
  ...
  /// @param        MontageTracker         The montage tracker associated with the montage.
  /// @returns      void
  void SetMontageBlendOutDelegate(FGMC_OnMontageBlendOutBegin& InOnMontageBlendOut, const FGMC_MontageTracker& InMontageTracker);
  ...
  /// @param        MontageTracker            The montage tracker associated with the montage.
  /// @returns      void
  void SetMontageNotifyBeginDelegate(FGMC_OnMontageNotifyBegin& InOnMontageNotifyBegin, const FGMC_MontageTracker& InMontageTracker);
  ...
  /// @param        MontageTracker          The montage tracker associated with the montage.
  /// @returns      void
  void SetMontageNotifyEndDelegate(FGMC_OnMontageNotifyEnd& InOnMontageNotifyEnd, const FGMC_MontageTracker& InMontageTracker);
  ...
  /// @param        MontageTracker         The montage tracker associated with the montage.
  /// @returns      void
  void SetMontageCompleteDelegate(FGMC_OnMontageComplete& InOnMontageComplete, const FGMC_MontageTracker& InMontageTracker);
...
protected:
  ...
  /// Applies pre-processing to the extracted root motion parameters based on montage meta data.
  ///
...
protected:
  ...
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
  EGMC_MovementMode GetPreviousMovementModeSimulated() const;
  ...
  UFUNCTION(BlueprintCallable, Category = "General Movement Component")
  FRotator GetPreviousControlRotationSimulated() const;
...
protected:
  ...
  /// The velocity requested by path following.
